...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "YururiMap — 今の気持ちは？ / How are you feeling?" },
      { name: "twitter:title", content: "YururiMap — 今の気持ちは？ / How are you feeling?" },
      { property: "og:description", content: "Tap a mood to record how you feel." },
      { name: "twitter:description", content: "Tap a mood to record how you feel." },
